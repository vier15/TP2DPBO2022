  ...
  <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="formDivisi.php">Divisi</a>
                        </li>
                        <li class="nav-item">
    ...
    <section id="form-divisi">
        ...
        <h2 class="text-center pt-3">Input Divisi</h2>
            <form action="formDivisi.php" method="POST">
    ...
    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        echo "<td>
              <a href='formDivisi.php?id_hapus={$row['id_divisi']}' class='btn btn-danger''>Hapus</a>
              </td>";
        echo "</tr>";
        $i++;
    }
